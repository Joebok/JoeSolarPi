...
config['SolarEdge'] = {'; Use your site_id and api_key for your system':None, 'api_key': 'abcde', 'site_id':'123', 'responseTimeout':'10'}
...
config['Web'] = {'; Data storage for web viewer':None, 'storeData':'yes', 'webpath': 'data\\'}
