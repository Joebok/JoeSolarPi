...
config['PVSettings'] = {'; Determine scales to use for how much your system will produce. maxPower is the most kilowatts your system will procude at a time. maxEnergy is the max kilowatt hours your system produces in a day.':None, 'maxPower':'8', 'maxEnergy':'40'}
config['DisplaySettings']={'; Refresh is in seconds':None, 'refreshRate':'120', 'powerCols':'6', 'energyCols':'3', 'dimBat':'.3','rotation':'270','brightness':'.6'}
...
with open ('SolarData.config','w') as configfile:
